...
func main() {
	...
	// 	}
	// }
	url := "https://www.chronicleindia.in/current-affairs/13348-veteran-activist-tapan-bose-passes-away"

	articleDetails, err := scrapeArticleDetails(url)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Print(articleDetails)
